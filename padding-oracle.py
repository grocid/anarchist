# https://github.com/grocid/CTF/blob/master/CSAW/2016/neo/neo.py
...
def oracle(payload):
    ...
    if error_message in r.text: responses[payload] = False
...
# adjust at least these parameters
data = ''
url = ''
error_message = 'Caught exception during AES decryption...'
